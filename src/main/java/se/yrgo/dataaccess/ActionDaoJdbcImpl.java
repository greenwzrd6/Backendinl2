...
public class ActionDaoJdbcImpl { // implements ActionDao {
	...
	public void create(Action newAction) {
		template.update(INSERT_SQL, newAction.getDetails(), newAction.isComplete(), newAction.getOwningUser(),
	...
	private void createTables() {
		try {
			this.template.update(
					"CREATE TABLE ACTION (ACTION_ID integer generated by default as identity (start with 1), DETAILS VARCHAR(255), COMPLETE BOOLEAN, OWNING_USER VARCHAR(20), REQUIRED_BY DATE)");
		} catch (org.springframework.jdbc.BadSqlGrammarException e) {
			System.err.println("Assuming the Action table exists");
		}
	}
	...
	public void update(Action actionToUpdate) throws RecordNotFoundException {
		this.template.update(UPDATE_SQL, actionToUpdate.getDetails(), actionToUpdate.isComplete(),
				actionToUpdate.getOwningUser(), actionToUpdate.getRequiredBy().getTime(), actionToUpdate.getActionId());
	}
